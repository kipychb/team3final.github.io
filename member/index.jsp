<%@page contentType="text/html;charset=utf-8" language="java" import="java.sql.*" %>
    <%@include file="../utils/config.jsp" %>
        ...
        <% int MemberID=(int) session.getAttribute("mid"); String sql="SELECT * FROM `member` WHERE MemberID = ?" ;
            PreparedStatement pstmt=con.prepareStatement(sql); pstmt.setInt(1, MemberID); ResultSet
