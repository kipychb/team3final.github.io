    ...
    <%@include file="counter.jsp" %>
        ...
        <body>
            ...
            <div id="cookie-banner"
                style="position:fixed; bottom:0; left:0; width:100%; background:linear-gradient(135deg, #333, #444); color:white; padding:18px 20px; text-align:center; display:none; z-index:9999; box-shadow:0 -4px 15px rgba(0,0,0,0.3); font-family:Arial, sans-serif;">
                <div
